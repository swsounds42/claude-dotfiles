...
```bash
INIT=$(node /Users/sam.warren@homebot.ai/.claude/get-shit-done/bin/gsd-tools.cjs state load)
...
```bash
node /Users/sam.warren@homebot.ai/.claude/get-shit-done/bin/gsd-tools.cjs commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
